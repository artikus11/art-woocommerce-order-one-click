<?php
/**
 * Simple product add to cart in Preorder mode
 *
 * This template can be overridden by copying it to yourtheme/art-woocommerce-order-one-click/add-to-cart/simple-preorder.php.
 *
...
<form
	...
	<?php if ( empty( $product->get_price() ) || ( $product->is_on_backorder( 1 ) ) || ! $product->is_in_stock() ) : ?>
