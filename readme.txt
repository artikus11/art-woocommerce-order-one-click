...
* Добавлен фильтр ```awooc_popup_image_height``` для изменения высоты изображения в окне
...
* Добавлен фильтр ```awooc_popup_price_header``` для возможности изменения надписи перед ценой в окне
...
* Добавлен фильтр ```awooc_popup_sku_header``` для возможности изменения надписи перед артикулом в окне
